...
def evaluation_function(solution: list[list[int]]):
    ...
    return math.ceil(total_cost) ## Pega o teto do custo
...
def save_results(save_path, q_max, r, times_to_best, best_costs, best_solution):
    ...
    with open(save_path, 'w') as out_file:
        ...
        print(file=out_file)
        print('Best Solution:',file=out_file)
...
def main():
    ...
    for vrp_path in args['targets']: ## para cada instância alvo
        ...
        save_results(args['save_path'], q_max, r, times_to_best, best_costs, alns.best_solution) ## salvando resultados finais
