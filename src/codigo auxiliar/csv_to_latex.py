...
def handle_args(args: dict):
    expected_args=['read_path', 'save_path', 'sep']
...
def main():    
    ...
    latex_table = csv_to_latex(read_path, separator=sep)
